        ...
        'secondary': [
            {
                ...
                'config': { 'path': os.getenv("TRANSCROBES_ZH_EN_ABC_DICT_PATH"),
            ...
            },
            {
                ...
                'config': { 'path': os.getenv("TRANSCROBES_ZH_EN_CEDICT_PATH"),
    ...
    'en:zh-Hans': {
        ...
        'default': {
            ...
            'transliterator': {
                ...
                'config': { 'path': os.getenv("TRANSCROBES_EN_CMU_DICT_PATH"),
        ...
        'secondary': [
            {
                ...
                'config': { 'path': os.getenv("TRANSCROBES_EN_ZH_ABC_DICT_PATH"),
        ...
        'metadata': [
            {
                ...
                'config': { 'path': os.getenv("TRANSCROBES_EN_SUBTLEX_FREQ_PATH"),
