...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('-f', '--from_lang', type=str, default='zh-Hans',
                            help='L2 - learning language')
        parser.add_argument('-t', '--to_lang', type=str, default='en',
                            help='L1 - native(ish) language')
    ...
    def handle(self, *args, **options):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            try:
                ...
                duman.add_user(username=username, email=email, password=password,
                               from_lang=from_lang, to_lang=to_lang)
            except Exception:
                self.stdout.write("There was an error creating the user, make sure you have entered a valid "
